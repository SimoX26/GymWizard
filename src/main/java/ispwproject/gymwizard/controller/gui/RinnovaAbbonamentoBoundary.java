...
public class RinnovaAbbonamentoBoundary extends AbstractGUIController{

    @FXML
    private void on10IngressiClick(ActionEvent event) {
        System.out.println("10 INGRESSI button clicked.");
        this.switchScene(event, "/views/RiepilogoOrdineView.fxml");
    }
    ...
    public void onBackClick(ActionEvent backEvent) {
        ...
        switchScene(backEvent, "/views/StatoAbbonamentoView.fxml");
    }
